...
define('ADDING_TITLE', 'A&nacute;adir Producto(s) al Pedido #%s');
...
define('TABLE_HEADING_UNIT_PRICE', 'Prrecio<br>(excl.)');
...
define('TABLE_HEADING_DATE_ADDED', 'Fecha A&nacute;adido');
...
define('TEXT_ADD_NEW_PRODUCT', 'A&nacute;adir productos');
...
define('TEXT_BUTTON_ADD_PRODUCT', 'A&nacute;adir al Pedido');
define('TEXT_CLOSE_POPUP', '<u>Cerrar</u> [x]');
define('TEXT_ADD_PRODUCT_INSTRUCTIONS', 'Siga a&nacute;adiendo productos hasta que termine.<br>Entonces cierre esta pesta&nacute;a/ventana, regrese a la pesta&nacute;a/ventana principal, y presionne el Boton "Actualizar".');
...
define('HINT_TOTALS', 'Puede hacer descuentos a&nacute;adiendo valores negativoss. Subtotal, total impuestos y Total Pedido no son editables. Cuando a&nacute;ada componentes en el pedido mediante AJAX asegurese de introducir el titulo primero o el codigo no reconocera la entrada (por ejemplo, un componente sin titulo es borrado del pedido).');
...
define('AJAX_SELECTED_NO_SHIPPING', 'Ha seleccionado un metodo de envio para este pedido pero parece que no hay ninguno almacenado en la base de datos.  Le gustaria a&nacute;adir este gasto de envio en el pedido?');
