...
DROP TABLE IF EXISTS wposc_articles;
CREATE TABLE wposc_articles (
  articles_id int NOT NULL auto_increment,
  articles_image varchar(96) default NULL,
  ...
  articles_sum int(11) NOT NULL default '0',
  articles_type int(5) NOT NULL default '0',
  articles_pos int(5) NOT NULL default '0',
  PRIMARY KEY  (articles_id),
  KEY idx_articles_date_added (articles_date_added)
);
DROP TABLE IF EXISTS wposc_articles_description;
CREATE TABLE wposc_articles_description (
  articles_id int NOT NULL auto_increment,
  language_id int(11) NOT NULL default '1',
  articles_name varchar(96) NOT NULL default '',
  articles_description text,
  articles_viewed int(11) default '0',
  PRIMARY KEY  (articles_id,language_id),
  KEY articles_name (articles_name)
);
DROP TABLE IF EXISTS wposc_articles_to_categories;
CREATE TABLE wposc_articles_to_categories (
  articles_id int NOT NULL default '0',
  categories_id int NOT NULL default '0',
  PRIMARY KEY  (articles_id,categories_id)
);
DROP TABLE IF EXISTS wposc_configuration;
CREATE TABLE wposc_configuration (
  wposc_id int NOT NULL auto_increment,
  wposc_name varchar(32) NOT NULL,
  wposc_value varchar(255) NOT NULL,
  PRIMARY KEY  (wposc_id)
);
