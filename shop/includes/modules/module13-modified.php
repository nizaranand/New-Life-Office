...
//// search in articles
  $select_str2 = "select distinct articles_id, articles_image, ad.articles_name from " . 'wposc_articles' . " a, " . 'wposc_articles_description' . " ad, " . TABLE_CATEGORIES . " c, " . 'wposc_articles_to_categories' . " a2c";
    ...
    for ($i=0, $n=sizeof($search_keywords); $i<$n; $i++ ) {
      switch ($search_keywords[$i]) {
        ...
        default:
          ...
          if (isset($HTTP_GET_VARS['search_in_description']) && ($HTTP_GET_VARS['search_in_description'] == '1')) $where_str2 .= " or ad.articles_description like '%" . tep_db_input($keyword) . "%'";
          $where_str2 .= ')';
          break;
      }
    }
  ...
  $listing_sql2 = $select_str2 . $where_str2 . $order_str2;
