...
$page_content .= '<tr>'."\n";
$page_content .= '<td width="100%" valign="top">'.tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"') . '<table border="0" width="100%" cellspacing="0" cellpadding="0">'."\n";
$page_content .= '<tr>'."\n";
...
$page_content .= '<td class="main" width="50%" valign="top">'. TEXT_SELECTED_SHIPPING_DESTINATION .'</td>'."\n";
...
$page_content .= '<tr>'."\n";
$page_content .= '<td>'. tep_draw_separator('pixel_trans.gif', '10', '1'). '</td>'."\n";
$page_content .= '<td class="main" width="50%" valign="top">'. TEXT_SELECT_OTHER_SHIPPING_DESTINATION .'</td>'."\n";
...
$page_content .= '<td class="main" colspan="2"><b>'. tep_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']) . '</b></td>'."\n";
$page_content .= '<td class="main" align="right">'. tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $sendto)) . '</td>'."\n";
$page_content .= '<td width="10">'. tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>'."\n";
$page_content .= ' </tr>'."\n";
$page_content .= '<tr>'."\n";
$page_content .= '<td width="10">'. tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>'."\n";
...
$page_content .= '<td><table border="0" width="100%" cellspacing="0" cellpadding="2">'."\n";
$page_content .= '<tr>'."\n";
$page_content .= '<td class="main"><b>'. TABLE_HEADING_NEW_SHIPPING_ADDRESS .'</b></td>'."\n";
$page_content .= '</tr>'."\n";
$page_content .= '</table></td>'."\n";
$page_content .= '</tr>'."\n";
$page_content .= '<tr>'."\n";
...
$page_content .= ' <tr>'."\n";
$page_content .= '<td>'. tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>'."\n";
$page_content .= '<td class="main" width="100%" valign="top">'. TEXT_CREATE_NEW_SHIPPING_ADDRESS .'</td>'."\n";
$page_content .= '<td>'. tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>'."\n";
$page_content .= '</tr>'."\n";
$page_content .= '<tr>'."\n";
$page_content .= ' <td>'. tep_draw_separator('pixel_trans.gif', '10', '1') . '</td>'."\n";
...
$page_content .= '<td class="main" align="right">'. tep_draw_hidden_field('action', 'submit') . '<input type="image" src="images/continue.gif" value="'.IMAGE_BUTTON_CONTINUE.'"></td>'."\n";
$page_content .= '<td width="10">'. tep_draw_separator('pixel_trans.gif', '10', '1') . '</td>'."\n";
$page_content .= '</tr>'."\n";
$page_content .= '</table></td>'."\n";
$page_content .= '</tr>'."\n";
...
$page_content .= ' </tr>'."\n";
$page_content .= '<tr>'."\n";
$page_content .= '<td>'.'<input type="button" class="'.cssclass('BUTTON_BACK').'" value="'.IMAGE_BUTTON_BACK.'" onclick="javascript:rk_redirect(\''. tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') .'\');"></td>'."\n";
$page_content .= '</tr>'."\n";
