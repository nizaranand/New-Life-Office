...
$module .= '<a href="' . tep_href_link(DIR_WS_IMAGES . $products_image) . '" title="'.$caption.'" rel="lightbox[roadtrip]" >' . tep_image(DIR_WS_IMAGES . $products_image, $new_products['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>'."\n";
$module .= '</div>';
$module .= '</div>';
  }
$module .= '<div style="clear:both;height:10px"></div>'."\n";
