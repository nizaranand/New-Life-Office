...
switch ($request) {
    ...
    case "true":
        ...
        break;
    case "":
 	if (getenv('SERVER_PORT') == '443')  $request_type = 'SSL';
	if (strpos(HTTPS_SERVER, getenv('HTTP_X_FORWARDED_HOST') )!==FALSE) $request_type = 'SSL'; 
        break;
}
} 
*/
...
// add the products model to the breadcrumb trail
  if (isset($HTTP_GET_VARS['products_id']) && !isset($HTTP_GET_VARS['tag_id'])) {
...
// set which precautions should be checked
  ...
  if (!tep_session_is_registered('wptheme') || isset($HTTP_GET_VARS['wptheme'])) {
    if (!tep_session_is_registered('wptheme')) tep_session_register('wptheme');

    if (isset($HTTP_GET_VARS['wptheme'])) {
      $wptheme = $HTTP_GET_VARS['wptheme'];
    } else {
      $wptheme = 'default';
    }
  }
