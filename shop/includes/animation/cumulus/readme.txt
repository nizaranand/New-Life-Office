...
As of  version 1.12 the source code is available from wordpress.org under the GP license. Click "other versions" and get the developer version.
...
* Big Bear maintains the [Joomla version](http://joomlabear.com/Downloads/).
