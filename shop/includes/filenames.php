...
// define the filenames used in the project
  ...
  define('FILENAME_ADMIN_LOGIN', 'admin_login.php');
  define('FILENAME_ADMIN_CREATE_ACCOUNT', 'admin_create_account.php');
  define('FILENAME_ADMIN_LIST_PRODUCTS', 'admin_list_products.php');
