 ...
 */
$cfg['PmaAbsoluteUri'] = 'https://ssl37.pair.com/inksp3c1/newlifeoffice/phpMyAdmin/';
...
$i++;
$cfg['Servers'][$i]['host']          = 'db44.pair.com'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'inksp3c1_38';      // MySQL user
$cfg['Servers'][$i]['password']      = 'PWtQQ4js';          // MySQL password (only needed
