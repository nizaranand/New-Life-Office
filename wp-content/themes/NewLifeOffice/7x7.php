...
<div id="Table_01_order1">
	<div id="order-process1-01_">
		<img id="order_process1_01" src="<?php bloginfo('stylesheet_directory');?>/images/order_process1_01.jpg" width="262" height="22" alt="" />
	</div>
	...
	<div id="order-process1-07_">
		<img id="order_process1_07" src="<?php bloginfo('stylesheet_directory');?>/images/order_process1_07.jpg" width="262" height="11" alt="" />
	</div>
</div>
</div>
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div id="p_price6x6">
				 <ul>
					<li style="font-family:Arial;font-weight:bold;font-size:12px;"></li>
					<li style="font-family:FranklinGothic Demi;font-size:19.63px;color:#111111;text-decoration:line-through;"></li>
				 </ul>
				 <ul>
					<li style="font-family:Arial;font-weight:bold;font-size:12px;">Price:</li>
					<li style="font-family:FranklinGothic Demi;font-size:24.85px;color:#d70000;">$925</li>
				 </ul>
		<ul style="font-family:FranklinGothic Demi;font-size:19.63px;color:#d70000;width:152px;text-align:right;padding-top:10px;">
				 ...
				 <ul style="float:left;width:350px;text-align:left;font-weight:bold;font-size:12px;font-family:Arial;margin-top:10px;">
				 <li> </li>
				 </ul>
				</div>
				<div id="choose_layout">
				<a href="<?php echo get_permalink(63) ?>?osCsid=<?=$osCsid;?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Choose a Layout &gt;</a>
				</div>
				
				
				<div id="Feature">
				<div id="Featureimage">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/big_cubicles/7x7.jpg"  />
				</div>
				</div>
				<div id="Feature_x_b">
				<div id="Feature_x_7x7">
				<div id="benefits">
				
				<p style="height:50px;padding-right:30px;color:#d70000;">65" High Steelcase Acoustic Panels 
with choice of 4 fabric colors</p>
				<p style="height:48px;padding-right:30px;">Locking Overhead Storage Bins 
with Optional Task Light</p>
				<p style="height:48px;padding-right:30px;color:#d70000;">24" Deep Laminate Workspaces
in Cherry or Maple Finishes</p>
				<p style="height:36px;">Locking File Pedestal</p>
				<p style="height:36px;color:#d70000;">4 Duplex Receptacles Per Workstation Power</p>
				...
				<div id="plan_n_veiw">
				<div id="plan_image">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/planview/7x7/6x6_plan.jpg"  />
				...
				<ul>
				<li><a href="http://www.newlifeoffice.com/cubicles/7x7/layout_7x7/?osCsid=<?=$osCsid;?>">TYPICAL LAYOUTS & 3D VIEWS</a></li>
				</ul>
				</div>
				</div>
