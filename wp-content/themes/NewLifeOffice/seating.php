...
$home = true;
get_header(); ?>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory');?>/js/store.js"></script>
...
<div id="navright"> </div>
<h1 class="mainheader">Office Chairs</h1>
...
<h2 class="top-subheader">Available Products</h2>

	
 <?php echo do_shortcode('[nggallery id=18 template=newlifeprice  w=120px h=100px]'); ?>
