<?php
/*
Template Name: Layout_callstation
*/
?>
...
font-size:16px;color:#000000;padding:10px 0 0 0;margin:0;">Choose a layout - Mouseover to see the 3D photo</p></div>		
			...
			<div style="float:left;padding-left:280px;width:478px;">
			<a class="g_open_8_4call" href="<?php echo get_permalink(81);?>?type=Group&qn=8&qubicles=4x4&pid=33&osCsid=<?=$osCsid;?>"></a>
			</div>
			<div style="padding-left:260px;width:478px;float:left;">
			<a class="s_open_4_4call" href="<?php echo get_permalink(81);?>?type=Row&qn=4&qubicles=4x4&pid=41&osCsid=<?=$osCsid;?>"></a>
			</div>			
