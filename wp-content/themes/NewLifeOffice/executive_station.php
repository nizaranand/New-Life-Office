<?php
/*
Template Name: Executive Station
*/
?>
<?php
get_header(); ?>
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div id="p_price6x6">
				 ...
				 <ul>
					...
					<li style="font-family:FranklinGothic Demi;font-size:24.85px;color:#d70000;">$979</li>
				 </ul>
		<ul style="font-family:FranklinGothic Demi;font-size:19.63px;color:#d70000;width:152px;text-align:right;padding-top:10px;">
				...
				<a href="<?php echo get_permalink(71) ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Choose a Layout &gt;</a>
				</div>
				
				
				<div id="Feature">
				<div id="Featureimage">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/big_cubicles/executive.jpg"  />
				</div>
				</div>
				<div id="Feature_x_b">
				<div id="Feature_x_executive">
				<div id="benefits">
				
				<p style="height:50px;padding-right:30px;color:#d70000;">Locking Overhead Storage Bins 
with Optional Task Light</p>
				<p style="height:54px;padding-right:30px;">24" Deep Laminate Workspaces
in Cherry or Maple Finishes</p>
				<p style="height:52px;padding-right:30px;color:#d70000;">Locking File Pedestal</p>
				<p style="height:36px;"></p>
				<p style="height:36px;color:#d70000;"></p>
				...
				<div id="plan_n_veiw">
				<div id="plan_image">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/planview/executive/6x6_plan.jpg"  />
				<p><a href="#">PLAN VIEW</a></p>
				</div>
				...
				<ul>
				<li><a href="http://www.newlifeoffice.com/cubicles/executive-station/layout_executive/?osCsid=<?=$osCsid;?>">TYPICAL LAYOUTS & 3D VIEWS</a></li>
				</ul>
				</div>
				</div>
