...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div id="p_price6x6">
				 ...
				 <ul>
					...
					<li style="font-family:FranklinGothic Demi;font-size:24.85px;color:#d70000;">$345</li>
				 </ul>
		<ul style="font-family:FranklinGothic Demi;font-size:19.63px;color:#d70000;width:152px;text-align:right;padding-top:10px;">
				...
				<a href="<?php echo get_permalink(69) ?>?osCsid=<?=$osCsid;?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Choose a Layout &gt;</a>
				</div>
				
				
				<div id="Feature">
				<div id="Featureimage">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/big_cubicles/4call.jpg"  />
				</div>
				</div>
				<div id="Feature_x_b">
				<div id="Feature_x_4call">
				<div id="benefits">
				
				<p style="height:50px;padding-right:30px;color:#d70000;">53" High Steelcase Acoustic Panels 
with choice of 4 fabric colors</p>
				<p style="height:48px;padding-right:35px;">24" Deep Laminate Workspaces
in Cherry or Maple Finishes</p>
				<p style="height:48px;padding-right:30px;color:#d70000;">1 Duplex Receptacle Per Workstation Power</p>
				...
				<div id="plan_n_veiw">
				<div id="plan_image">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/planview/4call/6x6_plan.jpg"  />
				...
				<ul>
				<li><a href="http://www.newlifeoffice.com/cubicles/4call-station/layout_callstation/?osCsid=<?=$osCsid;?>">TYPICAL LAYOUTS & 3D VIEWS</a></li>
				</ul>
				</div>
				</div>
	</div>
