...
else if ($type == 'Row' && $qubicles == '6x653') {
	// type = row
	switch ($qn) {
		case 2:
			$openPrice = '$2,214';
...
<div id="Table_01_order3">
	...
	<div id="order-process3-07_">
		<img id="order_process3_07" src="<?php bloginfo('stylesheet_directory');?>/images/order_process3_07.gif" width="262" height="11" alt="" />
			...
			<h4 style="height:20px;width:314px;float:left;padding:0;margin:0;font-family:FranklinGothic Demi;font-size:19.63px;color:#999999;">53" H</h4>
			</div>			
