...
$home = true;
get_header(); ?>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory');?>/js/desk.js"></script>
...
<div id="navright"> </div>
<h1 class="mainheader">Office Desks</h1>
...
<h2 class="top-subheader">Available Product</h2>

	
<?php echo do_shortcode('[nggallery id=19 template=newlifeprice]'); ?>
