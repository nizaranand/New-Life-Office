...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div id="p_price6x6">
				 ...
				 <ul>
					...
					<li style="font-family:FranklinGothic Demi;font-size:24.85px;color:#d70000;">$899</li>
				 </ul>
		<ul style="font-family:FranklinGothic Demi;font-size:19.63px;color:#d70000;width:152px;text-align:right;padding-top:10px;">
				...
				<a href="<?php echo get_permalink(57) ?>?osCsid=<?=$osCsid;?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Choose a Layout &gt;</a>
				</div>
...
in Cherry or Maple Finishes</p>
				...
				<div id="plan_n_veiw">
				<div id="plan_image">
				<img src="<?php bloginfo('stylesheet_directory')?>/images/planview/6x6/6x6_plan.jpg"  />
				...
				<ul>
				<li><a href="http://www.newlifeoffice.com/cubicles/6x6/layout_6x6/?osCsid=<?=$osCsid;?>">TYPICAL LAYOUTS & 3D VIEWS</a></li>
				</ul>
				</div>
				</div>
				<!--
