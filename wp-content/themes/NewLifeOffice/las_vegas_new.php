...
<div id="header">
    ...
    <h2>3475 W Post Rd, Ste 120<br />
	Las Vegas, NV 89118</h2>
	<h2>(702) 212-0407</h2>
    </div>
    </div>
    <div id="rightimg">
...
<div id="locphoto"><a href="http://www.newlifeoffice.com/"><img src="<?php bloginfo('stylesheet_directory');?>/images/las_vegas.jpg"/></a></div>   
</div>
