...
[...]<br />
		...
		<div id="o21">
			...
			<p class="ex" ><?php echo sprintf(__('%s can reside in your /plugins/custom-cforms folder to protect it from future (auto) upgrades.', 'cforms'),'<strong>my-functions.php</strong>'); ?></p>
		</div>
