...
class nggMonoslideshow {
    ...
    function default_options() {
        ...
        $this->options['defaultWidth']      = 640;
        $this->options['defaultHeight']     = 480;
        ...
        $this->options['scaleMode']         = 'downscaleToFit';
        $this->options['kenBurnsMode']      = 'none';
        $this->options['disableLogo']       = true;
        					...
        					<td>
                                <select size="1" name="monoslideshow[preset]">
                                    ...
                                    <option value="zoom" <?php selected('zoom', $this->options['preset']); ?> ><?php _e('Zoom', 'monoss'); ?></option>
                                     <option value="newlife" <?php selected('newlife', $this->options['preset']); ?> ><?php _e('New Life Default', 'monoss'); ?></option>
             					</select>
