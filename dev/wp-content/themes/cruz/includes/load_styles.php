...
$fam1 = font_family($crz_heading_font);
$fam2 = font_family($crz_ft_heading_font);
$fam3 = font_family($crz_bl_heading_font);
$famx = $fam1;
...
<style type="text/css">
<?php if( $crz_custom_headings == 'true' ) { ?>
h1, h2, h3, h4, h5 { 
font-family:'<?php echo $crz_heading_font; ?>', sans-serif; 
color:#<?php echo $crz_heading_color; ?>; 
font-weight:<?php echo font_weight($crz_heading_font_style);?>;
font-style:<?php echo font_style($crz_heading_font_style);?>
}
.page_titles h1 { 
font-family:'<?php echo $crz_ft_heading_font; ?>', sans-serif; 
color:#<?php echo $crz_ft_heading_color; ?>; 
font-weight:<?php echo font_weight($crz_ft_heading_font_style);?>;
font-style:<?php echo font_style($crz_ft_heading_font_style);?>
 }
.entry h2 { 
font-family:'<?php echo $crz_bl_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($crz_bl_heading_font_style);?>; 
font-weight:<?php echo font_weight($crz_bl_heading_font_style);?>
}
.entry h2, .entry h2 a {
color:#<?php echo $crz_bl_col; ?>;
 }
.entry h2 a:hover { 
color:#<?php echo $crz_bl_hvr_col; ?>;
text-decoration:none
 }
.sidebar h5 {
font-family:'<?php echo $crz_sb_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($crz_sb_heading_font_style);?>; 
font-weight:<?php echo font_weight($crz_sb_heading_font_style);?>;
color:#<?php echo $crz_sb_heading_color; ?>;
} 
.secondary h5 {
font-family:'<?php echo $crz_sc_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($crz_sc_heading_font_style);?>; 
font-weight:<?php echo font_weight($crz_sc_heading_font_style);?>;
color:#<?php echo $crz_sc_heading_color; ?>;
} 	
<?php
}

if( $crz_layout == 'stretched' ) {?>
.header_wrap, .utility_wrap, .featured_wrap, .slider_wrap, .primary_wrap, .secondary_wrap, .footer_wrap { background:none; margin-top:0px; border:none }
.header { background:#fff }
.utility { background:#333 url(<?php echo get_template_directory_uri();?>/images/nav_bg_overlay.png) 0px 1px repeat-x }
.footer, body { background:#272727;  margin-bottom:0px }
.featured { background:#f7f7f7; border-bottom:1px solid #ededed }
.primary { background:#fff }
.secondary { background:#f7f7f7; border-top:1px solid #ededed }
.footer { border-top:1px solid #212121 }
<?php 
} // Stretched Layout

echo( '.brand { padding:'.$crz_logo_mrgtop.'px 0px '.$crz_logo_mrgbtm.'px 30px }');
echo( '.slider, .cycle_slider, .cycle_slider li, .nivo_wrapper, #nivo_slider { height:'.$crz_sl_ht.'px }');
