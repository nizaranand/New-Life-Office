<?php
/*
Template Name: port 2col w/sidebar
*/
			...
			if( have_posts() ) :
				...
				<ul class="port2">
					<?php while ($wp_query->have_posts()) : $wp_query->the_post();
						...
						<?php if ( $img ) { ?><a rel="prettyPhoto[group1]" href="<?php echo $img; ?>"><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $img; ?>&amp;w=280&amp;h=180&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>"/></a><?php } ?> </div>
<?php if ( !$titles ) {
						?>
                            <div class="port_content">
                                <a class="port_title" href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf( esc_attr__( 'Permanent link to %s', 'cruz' ), the_title_attribute( 'echo=0' ) ); ?>"><?php the_title(); ?></a>                           
                            </div>   
                        <?php } ?>
                        </li>
                        <?php $counter++; 
