...
define("PEXETO_THUMSLIDER_POSTTYPE", 'thumbnailslider');
define("PEXETO_ACCORDSLIDER_POSTTYPE", 'accordslider');
define("PEXETO_NIVOSLIDER_POSTTYPE", 'nivoslider');
...
$pexeto_data->custom_posttypes=array(PEXETO_THUMSLIDER_POSTTYPE, PEXETO_ACCORDSLIDER_POSTTYPE, PEXETO_NIVOSLIDER_POSTTYPE);
...
$pexeto_data->custom_pages=array(PEXETO_THUMSLIDER_POSTTYPE =>
new PexetoCustomPage(PEXETO_THUMSLIDER_POSTTYPE, array(
...
), 'Thumbnail Slider', true, PEXETO_OPTIONS_PAGE, 'image_url', PEXETO_SLIDER_TYPE, 'slider-thumbnail.php'),
PEXETO_ACCORDSLIDER_POSTTYPE=>
new PexetoCustomPage(PEXETO_ACCORDSLIDER_POSTTYPE, array(
array('id'=>'image_url', 'type'=>'upload', 'name'=>'Image URL', 'required'=>true),
array('id'=>'imgtitle', 'type'=>'text', 'name'=>'Image Title'),
array('id'=>'image_link', 'type'=>'text', 'name'=>'Image Link'),
array('id'=>'description', 'type'=>'textarea', 'name'=>'Image Description')
), 'Accordion Slider', true, PEXETO_OPTIONS_PAGE, 'image_url', PEXETO_SLIDER_TYPE, 'slider-accordion.php'),
...
function pexeto_add_custom_pages(){
	...
	foreach($pexeto_data->custom_pages as $page){
		add_submenu_page( $page->parent_slug, $page->page_name, $page->page_name, 'delete_pages', $page->post_type, 'pexeto_build_custom_page' );
	}
}
