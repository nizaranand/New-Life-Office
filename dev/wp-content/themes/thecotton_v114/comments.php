...
<div id="respond">
  ...
  <?php else : ?>
  <h2><?php echo pex_text('_leave_comment_text'); ?></h2>
  <hr />
  <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php"
	method="post" id="commentform">
    <?php if ( !is_user_logged_in() ) : ?>
    <h6><span
	class="commentFormTitle"><?php echo pex_text('_comment_name_text'); ?></span><span class="mandatory">*</span><span
    ...
    <br />
    <h6><span class="commentFormTitle"><?php echo pex_text('_email_text'); ?></span><span class="mandatory">*</span><span
    ...
    <br />
    <h6><span class="commentFormTitle"><?php echo pex_text('_website_text'); ?></span></h6>
    <input type="text" name="url" id="url" class="commentInput"
	value="<?php echo esc_attr($comment_author_url); ?>" size="22"
	tabindex="3" />
	<br />
    <?php endif; ?>
    <h6><span class="commentFormTitle"><?php echo pex_text('_your_comment_text'); ?></span><span class="mandatory">*</span></h6>
    <textarea name="comment" id="comment" class="commentTextArea" cols=""
	rows="10" tabindex="4"></textarea>
    <p>
    
    <a href="" class="button" id="submit_comment_button" ><span><?php echo pex_text('_submit_comment_text'); ?></span></a>
<!--      <input name="submit" type="submit" id="submit" tabindex="5"-->
<!--	value="<?php echo pex_text('_submit_comment_text'); ?>" />-->
