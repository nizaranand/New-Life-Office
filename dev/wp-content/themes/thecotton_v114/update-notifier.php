...
define( 'NOTIFIER_THEME_NAME', 'The Cotton' ); // The theme name
define( 'NOTIFIER_THEME_SHORT_NAME', 'cotton' ); // The theme short name
define( 'NOTIFIER_XML_FILE', 'http://pexeto.com/updates/cotton.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 43200 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
