...
<?php
  ...
  $args=array('post_type'=>'portfolio', 'posts_per_page'=>get_option('teardrop_theme_portfolio_items'), 'paged'=>$paged);
  ...
  <div class="portfolio" id="onecol">    
  <?php echo teardrop_image(array('type'=>'onecol','url'=>$pimg_url,'width'=>327,'height'=>230)) ?>
	<h4 class="port-title">
