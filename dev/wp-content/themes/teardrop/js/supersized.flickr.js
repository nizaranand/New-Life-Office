...
(function($){
	...
	$(document).ready(function() {
		$('body').prepend('<div id="supersized-loader"></div>').prepend('<div id="supersized" class="superflickr"></div>');
	});
	...
	$.supersized = function( options ) {
		...
		$(window).load(function(){
			...
			$('.main,#single-img, #supersized').each(function(){$(this).animate({opacity:'1'},200,function(){
    //remove the opacity in IE
		...
		function resizenow() {
			return element.each(function() {
		  		...
		  		$("#single-img, #supersized img").each(function(){
