  ...
  if( have_posts() ) : 
    ...
    <?php endwhile; ?>
		...
		<div class="navigation">
			<div class="alignright older_entries"><?php next_posts_link('<div class="older_entries_text">Older Entries </div><div class="older_entries_icon">></div>') ?></div>
			<div class="alignleft newer_entries"><?php previous_posts_link('<div class="newer_entries_icon"><</div><div class="newer_entries_text"> Newer Entries</div>') ?></div>
		</div>
		<?php } ?>
  <?php else : ?>
