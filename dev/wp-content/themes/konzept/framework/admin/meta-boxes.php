...
function flowthemes_portfolio_meta_boxes() {
	...
	$meta_boxes = array(
		...
		'page_title' => array( 'name' => 'Title', 'title' => __('Title', 'flowthemes'), 'desc' => 'You can add title to your post using this custom field. It will be displayed above post. It\'s not very useful for posts but it\'s useful for pages. I don\'t recommend using this field for posts but it\'s here for your convenience.', 'type' => 'text' ),
		'page_description' => array( 'name' => 'Description', 'title' => __('Description', 'flowthemes'), 'desc' => 'You can add description to your post using this custom field. It will be displayed above post. It\'s not very useful for posts but it\'s useful for pages. I don\'t recommend using this field for posts but it\'s here for your convenience.', 'type' => 'textarea' ),
