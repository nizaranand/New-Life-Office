...
<form name="form-main-page" method="post" action="">
    ...
    <table class="form-table">
		...
		<option value="0" <?php echo $zero; ?>>Show tagline</option>
		<option value="1" <?php echo $first; ?>>Disable tagline</option>
        ...
        <td><textarea rows="6" cols="50" name="<?php echo $data_field_name11; ?>"><?php echo $opt_val11; ?></textarea><br/>
