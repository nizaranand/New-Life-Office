...
<div class="footer-bottom clearfix">
	...
	<div class="footer-affiliate">
		<a href="<?php $footer_affiliate=get_option('footer_affiliate'); echo $footer_affiliate?$footer_affiliate:"http://devatic.com/"; ?>" rel="external"><?php _e('Powered by Devatic', 'flowthemes'); ?></a>
	</div> <?php } ?>
		<?php wp_footer(); ?>
