...
class recentwidget extends WP_Widget {
    ...
    function recentWidget() {
        parent::WP_Widget(false, $name = 'PictureThis - Recent Posts');	
    }
...
class popularwidget extends WP_Widget {
    ...
    function popularWidget() {
        parent::WP_Widget(false, $name = 'PictureThis - Popular Posts');	
    }
...
class flickrwidget extends WP_Widget {
	function flickrWidget() {
		parent::WP_Widget(false, $name = 'PictureThis - Flickr Widget');
	}
