...
(function($){
  ...
  $.fn.mColorPicker.defaults = {
    imageFolder: '../wp-content/themes/picturethis/framework/admin/images/',
    swatches: [
      "#ffffff",
      "#ffff00",
      "#00ff00",
  ...
  $.fn.mColorPicker.drawPickerTriggers = function ($t) {
    ...
    if (hidden) {
      ...
      $('#' + id).css({
        ...
        '<span style="cursor:pointer;" id="icp_' + id + '" class="mColorPickerTrigger"><img src="../wp-content/themes/picturethis/framework/admin/images/mColorPicker/color.png" style="border:0;margin:0 0 0 3px" align="absmiddle"></span>'
  ...
  $.fn.mColorPicker.drawPicker = function () {
    ...
    $('#mColorPickerImg').css({
      ...
      'border':0,
      'cursor':'crosshair',
      'background-image':"url('../wp-content/themes/picturethis/framework/admin/images/mColorPicker/colorpicker.png')"
    });
    ...
    $('#mColorPickerImgGray').css({
      ...
      'border':0,
      'cursor':'crosshair',
      'background-image':"url('../wp-content/themes/picturethis/framework/admin/images/mColorPicker/graybar.jpg')"
    });
    ...
    if ($.fn.mColorPicker.init.showLogo) $('#mColorPickerFooter').prepend('<a href="http://meta100.com/" title="Meta100 - Designing Fun" alt="Meta100 - Designing Fun" style="float:right;" target="_blank"><img src="../wp-content/themes/picturethis/framework/admin/images/mColorPicker/meta100.png" title="Meta100 - Designing Fun" alt="Meta100 - Designing Fun" style="border:0;border-left:1px solid #aaa;right:0;position:absolute;"/></a>');
