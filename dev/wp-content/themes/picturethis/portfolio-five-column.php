...
<div class="page_content">
	...
	<ul class="five-column">
		...
		?>
			...
			$custom_image_url = get_post_meta(get_the_id(), 'custom_image_url', true);			$thumb = get_post_thumbnail_id(); 
			$image = vt_resize( $thumb,'' , 152, 130, true, 70 );
			if($url == "") {
...
$imgurl = get_post_meta(get_the_id(), "_lburl", true);
			...
			<img style="position:absolute;left:25%;top:22%;" src="<?php bloginfo('template_url'); ?>/images/preview.png" alt="<?php echo $lbtitle; ?>"/>
